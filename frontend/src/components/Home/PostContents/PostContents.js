      ...
      <div className={styles.posts}>
        ...
        <div className={styles.user}>
          <div className={styles.userContainer}>
            ...
            <div>
              <h4 style={{ color: "#3a3b3c" }}>Phạm Văn Công</h4>
        ...
        <div className={styles.inputCommentContainer}>
          <img src={postImage1} className={styles.userInput} />
            ...
            return (
              <div key={index} className={styles.listComment}>
                <div className={styles.item}>
                  <img className={styles.userComment} src={postImage1} />
                  <div className={styles.contentComment}>
                    <h3 className={styles.nameUser}>Phạm Văn Công</h3>
                    <h4>{text}</h4>
                  </div>
                </div>
